(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    8619: function (e, t, r) {
      Promise.resolve().then(r.bind(r, 22));
    },
    7016: function (e, t, r) {
      'use strict';
      r.d(t, {
      ...
      function o() {
        return (o = (0, s._)(function () {
          ...
          return (0, a.Jh)(this, function (n) {
            switch (n.label) {
              case 0:
                (e = 'http://34.73.18.215:8000/positions/'), (n.label = 1);
              case 1:
                return n.trys.push([1, 4, , 5]), [4, fetch(e)];
              case 2:
                if (!(t = n.sent()).ok)
              ...
              case 4:
                throw (
                  ((r = n.sent()),
                  Error('Error in getPositions: '.concat(r.message)))
                );
              case 5:
                return [2];
            }
        ...
        return (u = (0, s._)(function (e) {
          ...
          return (0, a.Jh)(this, function (s) {
            switch (s.label) {
              ...
              case 2:
                if (!(r = s.sent()).ok)
                  throw Error('Request failed with status '.concat(r.status));
                return [4, r.json()];
              case 3:
                return [2, s.sent()];
              case 4:
                throw (
                  ((n = s.sent()),
                  Error('Error in getPosition: '.concat(n.message)))
                );
              case 5:
                return [2];
            }
      ...
      function h() {
        return (h = (0, s._)(function (e, t, r, n) {
          var s, i, o, c;
          return (0, a.Jh)(this, function (a) {
            switch (a.label) {
              case 0:
                (s = { name: e, company: t, email: r, message: n }),
                            ...
                            return (0, c.jsx)(
                              ...
                              (0, a._)((0, s._)({}, o({ row: e })), {
                                children: e.cells.map(function (t) {
                                  return (0,
                                  c.jsx)(c.Fragment, { children: (0, c.jsx)(l.pj1, { children: t.id.endsWith('id') ? (0, c.jsxs)(c.Fragment, { children: [(0, c.jsx)(p(), { href: window.location.href.replace('positions', '') + 'apply/?position=' + t.value, children: 'Apply' }), console.log(e)] }) : (0, c.jsx)(c.Fragment, { children: t.value }) }, t.id) });
                                }),
                              }),
                              e.id
                            );
              ...
              r &&
                (0, c.jsxs)('li', {
                  children: [
                    ...
                    (0, c.jsx)(l.rUS, { href: r, children: 'Homepage' }),
                  ],
                }),
            ],
          });
          ...
          j)
            ...
            : (0, c.jsx)(l.rjZ, {
                ...
                children: (0, c.jsxs)(l.sgG, {
                  ...
                  className: 'repo-page__r1',
                  children: [
                    (0, c.jsx)(d, { headers: g, rows: S.slice(t, t + p) }),
                    (0, c.jsx)(l.tlE, {
                      totalItems: S.length,
